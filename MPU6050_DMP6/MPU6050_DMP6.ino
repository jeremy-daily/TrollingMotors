...
// Pin definitions
int intPin = 17;  // These can be changed, 2 and 3 are the Arduinos ext int pins
...
void setup()
{
  ...
  Serial.println("MPU6050 is online...1");
    Serial1.println("MPU6050 is online...1");
   c=0x68 ;
  if (c == 0x68) // WHO_AM_I should always be 0x68
  {  
    Serial.println("MPU6050 is online...");
    Serial1.println("MPU6050 is online...");
